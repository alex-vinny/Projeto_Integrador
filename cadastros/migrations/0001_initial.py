# Generated by Django 2.2.12 on 2021-11-21 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SenhaAluno', models.CharField(max_length=15, verbose_name='Senha Aluno')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CodEscola', models.CharField(max_length=5, verbose_name='Código Escola')),
                ('NumRegistro', models.CharField(max_length=8, verbose_name='Número Registro Professor')),
